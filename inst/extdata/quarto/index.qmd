...
#     geom_abline (slope = perp_slope, intercept = perp_intercept, col = "orange") +
#     geom_point (data = data, col = "red") +
#     ggplot2::theme_minimal ()
```


There are `r npkgs_requiring_maintenance` packages requiring maintenance.
