...
This graph shows a metric of main contributor absence. Repositories are only
shown for which main contributors have not recently contributed. The metric is
the prooprtion of overall commits made by now absent contributors.


```{ojs plot-all-ctb-abs}
Plot.plot({
