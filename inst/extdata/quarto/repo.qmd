...
issue_cmt_count = repoMetrics.filter(function(m) {
...
<div class="card" style="background: linear-gradient(to bottom, #33ccff 0%, #ff99cc 100%); text-align:center;">
<img src="bs-icons/tools.svg" alt="Bootstrap" width="32" height="32" style="margin-left:auto; margin-top:5px; margin-right:5px;">
<h2>Maintainers:</h2>
<div style="text-align:left;">
```{ojs}
htl.html`<ul>
    <li>${maintainer_count_txt}</li>
    <li>${ctb_count_txt}</li>
</ul>`
```
</div>
...
<div class="card" style="background-color:powderblue; text-align:center;">
<img src="bs-icons/chat-square-heart.svg" alt="Bootstrap" width="32" height="32" style="margin-left:auto; margin-top:5px; margin-right:5px;">
<h2>Popularity</h2>
<div style="text-align:left;">
```{ojs}
htl.html`<ul>
...
<div class="card" style="background: linear-gradient(to bottom, #33ccff 0%, #ff99cc 100%); text-align:center;">
<img src="bs-icons/pencil-square.svg" alt="Bootstrap" width="32" height="32" style="margin-left:auto; margin-top:5px; margin-right:5px;">
<h2>Test Coverage: `{ojs} test_coverage`%</h2>
</div>
...
<div class="card" style="background-color:powderblue; text-align:center;">
<img src="bs-icons/github.svg" alt="Bootstrap" width="32" height="32" style="margin-left:auto; margin-top:5px; margin-right:5px;">
