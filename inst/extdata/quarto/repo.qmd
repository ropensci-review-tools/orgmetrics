...
gitlog_data_in = FileAttachment("data/results-gitlog.json").json();
gitlogDataTranspose = gitlog_data_in.map(row => ({
    ...row,
    first_commit: new Date(row.first_commit)
}));

cranDataAll = FileAttachment("data/results-data-cran.json").json();
not_cran_in = FileAttachment("data/results-not-cran.json").json();
repos_on_r_univ = FileAttachment("data/data_is_on_r_univ.json").json();
data_r_univ_jobs = FileAttachment("data/data_r_univ_jobs.json").json();
data_r_univ_builds = FileAttachment("data/data_r_univ_builds.json").json();
```
