...
deps_in_org = deps[0]['deps_in_org'] ? ('Uses org pkgs: ' + deps[0]['deps_in_org']) : 'Uses no other pkgs in org';
revdeps_in_org = deps[0]['revdeps'] ? ('Used by org pkgs: ' + deps[0]['revdeps']) : 'Not used by any other pkgs in org';
```
