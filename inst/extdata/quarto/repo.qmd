...
similar_pkgs = matched_names.map(i => {
    ...
    return htl.html`<li><a href="/repo.html" onclick="localStorage.setItem('orgmetricsRepo', '${i}')">${i}</a></li>`
});
```
...
<a href='/maintainer.html'>${item}</a>${i < ctb_gh.length - 1 ? ", " : ""}</span>`);
...
<li>
<a href='/repo.html' onclick="localStorage.setItem('orgmetricsRepo', '${d}')">${d}</a>
</li>`);
...
<h2 style="margin-top:-20px;">Popularity &#38;<br>GitHub Activity</h2>
<div style="text-align:left;">
```{ojs}
htl.html`<ul>
...
<h2 style="margin-top:-20px;">Similar Packages</h2>
<div style="text-align:left;">
