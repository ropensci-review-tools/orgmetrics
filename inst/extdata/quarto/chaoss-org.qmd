...
### Proportion of issues that are bugs

This plot shows the propotion of all recent issues that are bug reports. Values
are only shown for repositories with a lot of bugs.

```{ojs}
console.log("------ctb abs: " + JSON.stringify(ctb_abs));
console.log("------issue_resp: " + JSON.stringify(issue_resp));
console.log("------issue_bugs: " + JSON.stringify(issue_bugs));
```
...
shown for repositories with poor issue labelling.
