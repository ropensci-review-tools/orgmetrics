...
deps_in_org <- table (unlist (deps$deps_in_org)) |>
    data.frame () |>
    dplyr::rename (package = "Var1", n = "Freq")
deps <- dplyr::left_join (deps, deps_in_org, by = "package") |>
    dplyr::mutate (n = ifelse (is.na (n), 0L, n)) |>
    dplyr::rename (num_imports_in_org = "n")
