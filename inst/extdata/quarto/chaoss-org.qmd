...
This shows the average values for these groups of metrics over time:
...
```{r}
ggplot2::ggplot (metrics_dates, ggplot2::aes (x = date, y = value, colour = name)) +
    ggplot2::geom_line (lty = 2) +
    ggplot2::geom_smooth (method = "lm", formula = "y ~ x", se = FALSE) +
    ggplot2::ylab ("Average metrics") +
