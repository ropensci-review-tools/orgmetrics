...
lower or upper 20% of all repositories. Clicking on the following button will
...
model_repo_ht_mult = model_repo_len < 15 ? 40 : 20
```
...
metrics_repo_ht_mult = metrics_repo_len < 15 ? 30 : 20
```


```{ojs plot-filtered-repo-metrics}
Plot.plot({
    height: metrics_repo_ht_mult * metrics_repo_len,
    marginLeft: 60,
    marginRight: 160,
    marginTop: 50,
    marginBottom: 50,
