...
test_coverage_txt = test_coverage ? (test_coverage * 100) + "%" : "none"
...
<h2 style="margin-top:-20px;">Maintainers:</h2>
...
<h2 style="margin-top:-20px;">Test Coverage: `{ojs} test_coverage_txt`</h2>
</div>
